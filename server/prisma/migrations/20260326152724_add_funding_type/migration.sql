...
INSERT INTO "new_universities" ("application_deadline", "category", "created_at", "degree_level", "id", "name", "notes", "program", "reminder_14_sent_at", "reminder_30_sent_at", "reminder_7_sent_at", "status", "updated_at", "user_id", "website_url") SELECT "application_deadline", "category", "created_at", "degree_level", "id", "name", "notes", "program", "reminder_14_sent_at", "reminder_30_sent_at", "reminder_7_sent_at", "status", "updated_at", "user_id", "website_url" FROM "universities";
