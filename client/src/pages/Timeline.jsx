...
const MASTERS_PHD_MILESTONES = [
  ...
  { id: 'transcript',   monthsBefore: 10, label: 'Request transcripts & WES evaluation', desc: 'TU/KU/PU transcripts can take 4–8 weeks — request multiple certified copies. Start WES credential evaluation in parallel (~$200, 4–8 weeks, required by most US programs). See wes.org.' },
  ...
  { id: 'bank_docs',    monthsBefore: -4, label: 'Prepare financial documents',      desc: 'US consulate requires proof of sufficient funds: 6+ months of bank statements, NRB letter, and sponsor affidavit if applicable. NRB letters can take 1–2 weeks — request early.' },
...
const UNDERGRAD_MILESTONES = [
  ...
  { id: 'transcript',   monthsBefore: 10, label: 'Request transcripts & SLC/SEE certificates',  desc: 'Board transcripts can take several weeks. Request early and get multiple certified copies. Check if your target programs require WES credential evaluation (wes.org).' },
